...
const props3 = ({header,paragraph}) => {
  return (
    <div>
        <div className="w-full flex  justify-center items-center flex-col gap-16 pt-7 pb-10 px-10">
    <div className="text-left lg:text-center px-[5%] flex  flex-col lg:gap-10 gap-5 ]">
      <p className="lg:text-[40px] lg:px-[13%]  text-[30px] leading-[60px] font-[700] text-[var(--text-color)]">
      {header}
      </p>
