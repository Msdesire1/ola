...
const Footer = () => {
  ...
  return (
    <section id="footer" className='bg-black'>
      <div className="bg-black lg:px-[100px] relative lg:pr-40">
        <div className="container py-10  lg:pl-20 ">
          <div className="flex justify-between md:flex-row flex-col items-start md:gap-10 md:items-center pt-10 pb-1">
            <div className="">
              <img src="/customcolor_logo_transparent_background 2.svg" alt="" />
            </div>
            <div className="mt-6">
              <ul className="flex lg:gap-2 gap-1.5">
                
                <li className="bg-text-yellow p-[20px] border border-text-yellow rounded-full flex justify-center items-center icon cursor-pointer hover:bg-transparent hover:border hover:border-text-yellow hover:text-text-yellow transition-all duration-500 text-[20px]">
                ...
                <li className="bg-text-yellow p-[10px] border border-text-yellow rounded-full flex justify-center items-center icon cursor-pointer hover:bg-transparent hover:border hover:border-text-yellow hover:text-text-yellow transition-all duration-500 text-[20px]">
                  <Link href={"#"}>
                  <TbBrandFacebook />
                  </Link>
                </li>
          ...
          <div className="flex lg:flex-row flex-col lg:gap-[80px] gap-10 mt-8 pb-10">
            <div className="grid md:w-[60%] gap-6 w-full grid-cols-2 md:grid-cols-4">
              <div className="space-y-6">
                <h2 className="font-bold text-lg text-text-yellow">Use Cases</h2>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
              ...
              <div className="space-y-6">
                <h2 className="text-text-yellow font-bold text-lg">Platforms</h2>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <Link href="https://exchange.tulupay.com/">Exchange</Link>
                  </li>
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <Link href="https://switch.tulupay.com/">switch</Link>
                  </li>
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <Link href="https://purse.tulupay.com/">Purse</Link>
                  </li>
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <Link href="https://voucher.tulupay.com/">Voucher</Link>
                  </li>
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <Link href="https://gift.tulupay.com/">Gift</Link>
                  </li>
                  <li className="md:mt-4 sm:mt-2 text-text-yellow hover:text-fade-text-color underline">
                    <Link href="https://tulupay.com/">See More</Link>
                  </li>
                </ul>
              </div>
              <div className="space-y-6">
                <h2 className="text-text-yellow font-bold text-lg">Company</h2>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
              ...
              <div className="space-y-6">
                <h2 className="text-text-yellow font-bold text-lg">Developer</h2>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
              ...
              <div className="space-y-6">
                <h1 className="font-bold text-lg text-text-yellow">Learn</h1>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <Link href="https://tulupay.com/tuluedu">TuluEdu.</Link>
                  </li>
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
              ...
              <div className="lg:space-y-6">
                <h2 className="text-text-yellow text-lg font-bold">Community</h2>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
              ...
              <div className="space-y-6">
                <h2 className="text-text-yellow text-lg font-bold">Resources</h2>
                <ul className="space-y-3 text-text-white-color mt-2">
                  <li className="md:mt-4 sm:mt-2 hover:text-text-yellow transition-all duration-500 text-[14px]">
                    <a href="/">Roadmap</a>
                  </li>
            ...
            <div className="bg-card-bg-color lg:w-[40%] h-full w-full md:block lg:block sm:block rounded-md p-8 space-y-3">
              {resp && resp.message && (
                <div
              ...
              <p className="text-text-white-color text-[20px] mb-[-10px] font-medium">
                Subcribe to our  newsletter
              </p>
              <p className="text-fade-text-color text-[13px] ">
                Sign up to receive new updates
              </p>
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center mt-[40px]">
                <input
                  type="email"
                ...
                <button
                  type="submit"
                  className="bg-dark-bg-color w-full mt-3 text-text-yellow p-4 rounded-md"
                  disabled={loading}
                >
          ...
          <div className="lg:flex justify-between text-fade-text-color pb-8 mt-10">
            <div className="flex text-center lg:gap-8 gap-6 md:gap-4 sm:gap-2 lg:px-12">
