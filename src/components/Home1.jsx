...
const Home1 = ({head,paragraph,btn,dark,img}) => {
  return (
    <div>

<div className="md:px-16 px-8 lg:px-28 py-8 md:py-10">
      <div className="flex  flex-col items-center text-[var(--text-color)] justify-center lg:flex-row md:gap-52   gap-2">
