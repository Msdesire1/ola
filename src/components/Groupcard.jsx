...
export const Groupcard = ({
  ...
  const SingleCard = ({ paragraph, head, icon }) => {
    return (
      <div className="text-[var(--text-color)] flex flex-row  gap-3">
        <div className="h-[25vh] p-[2px] w-[3px] rounded-sm bg-[var(--text-color)]"></div>
        <div className="flex flex-col gap-3">
          ...
          <p className="opacity-100 text-[14px] lg:text-[14px] font-[200]">{paragraph}</p>
        </div>
      </div>
    );
  };
  ...
  return (
    <section className="md:px-16 bg-[var(--secondary-color)] px-8 lg:px-24 py-10 md:py-20">
      <div className="container grid grid-cols-1  lg:grid-cols-3 leading-5 gap-10">
